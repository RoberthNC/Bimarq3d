...
const Contacto = () => {
  ...
  //TODO: Agregar el href a los iconos
  return (
    <div id="contactenos" className="flex flex-col md:flex-row md:justify-around items-center gap-8 py-8 px-10 bg-[#1E1A1A] md:h-96">
